...
const Register = () => {
  ...
  return (
    <div className="font-[sans-serif] bg-white text-white md:h-screen max-w-[1175px] mx-auto my-5">
      <div className="grid md:grid-cols-2 items-center gap-8 h-full">
        ...
        <div className="flex items-center md:p-8 p-6 bg-[#0C172C] h-full lg:w-11/12 lg:ml-auto">
          <form onSubmit={handleRegister} className="max-w-lg w-full mx-auto">
            ...
            <div className="mt-10">
              <label className="text-xs block mb-2">Profile Picture</label>
              <div className="relative flex items-center">
                <input
                  name="image"
                  type="text"
